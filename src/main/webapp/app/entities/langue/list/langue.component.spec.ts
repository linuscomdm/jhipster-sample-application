...
describe('Langue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'langue', component: LangueComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to langueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLangueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLangueIdentifier).toHaveBeenCalledWith(entity);
