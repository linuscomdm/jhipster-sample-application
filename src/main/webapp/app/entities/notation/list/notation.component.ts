...
import { EntityArrayResponseType, NotationService } from '../service/notation.service';
...
export class NotationComponent implements OnInit {
  ...
  trackId = (_index: number, item: INotation): number => this.notationService.getNotationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.notations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: INotation[] | null): INotation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.notationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
