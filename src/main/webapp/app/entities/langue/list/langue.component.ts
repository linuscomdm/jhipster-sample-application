...
import { EntityArrayResponseType, LangueService } from '../service/langue.service';
...
export class LangueComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILangue): number => this.langueService.getLangueIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.langues = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ILangue[] | null): ILangue[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.langueService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
