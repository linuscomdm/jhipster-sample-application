...
public interface PieceJointeRepository extends JpaRepository<PieceJointe, Long> {
    ...
    @Query(
        value = "select distinct pieceJointe from PieceJointe pieceJointe left join fetch pieceJointe.pjDdeTraductions",
    ...
    @Query("select distinct pieceJointe from PieceJointe pieceJointe left join fetch pieceJointe.pjDdeTraductions")
    List<PieceJointe> findAllWithToOneRelationships();

    @Query("select pieceJointe from PieceJointe pieceJointe left join fetch pieceJointe.pjDdeTraductions where pieceJointe.id =:id")
