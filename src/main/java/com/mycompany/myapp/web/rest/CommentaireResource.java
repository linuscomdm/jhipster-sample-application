...
import com.mycompany.myapp.service.CommentaireService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Commentaire}.
 */
@RestController
@RequestMapping("/api")
public class CommentaireResource {
    ...
    public ResponseEntity<List<Commentaire>> getAllCommentaires(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
