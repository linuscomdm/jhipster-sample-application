...
describe('Prestataire Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'prestataire', component: PrestataireComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to prestataireService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPrestataireIdentifier');
