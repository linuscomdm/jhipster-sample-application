...
import { EntityArrayResponseType, PrestataireService } from '../service/prestataire.service';
...
export class PrestataireComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPrestataire): number => this.prestataireService.getPrestataireIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.prestataires = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPrestataire[] | null): IPrestataire[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.prestataireService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
