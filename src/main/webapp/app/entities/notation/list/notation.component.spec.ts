...
describe('Notation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'notation', component: NotationComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.notations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to notationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNotationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNotationIdentifier).toHaveBeenCalledWith(entity);
